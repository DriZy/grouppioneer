...
$logo_meta = get_post_meta($id,'capital_page_logo',true);
...
$logo_retina_meta = get_post_meta($id,'capital_page_logo_retina',true);
...
$retina_logo_width = get_post_meta($id,'capital_page_logo_retina_width',true);
$retina_logo_height = get_post_meta($id,'capital_page_logo_retina_height',true);
if($logo_url == ''){
...
<div class="mobile-navbar">
	...
	if($mobile_header_cart != 0){
		capital_cart_button_header();
	}
	if($mobile_header_search != 0){
		capital_search_button_header();
	}?>
