	...
	<div class="container relative-container">
		...
		if ($header_left_blocks):
			...
			switch($key) {
				...
				case 'menu': echo '<div class="header-equaler"><div><div><a href="#" class="hidden-menu-opener"><i class="fa fa-bars"></i></a></div></div></div>';
				break;
		...
		if ($header_right_blocks):
			...
			switch($key) {
				...
				case 'menu': echo '<div class="header-equaler hidden-menu-opener-cont"><div><div><a href="#" class="hidden-menu-opener"><i class="fa fa-bars"></i></a></div></div></div>';
				break;
